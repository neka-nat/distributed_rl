...
def run_instances_and_wait(config_file):
    ...
    image_id = get_ami_id()
    res_act = run_instance(image_id, config['actors_instance_type'], config['key_name'], config['num_actors_instance'])
    res_learn = run_instance(image_id, config['learner_instance_type'], config['key_name'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('config_file', type=str, default='aws_config.yaml', help='Config file name.')
